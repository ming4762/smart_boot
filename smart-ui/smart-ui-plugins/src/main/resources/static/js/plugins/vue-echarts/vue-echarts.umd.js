(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-echarts"] = factory(require("vue"));
	else
		root["vue-echarts"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/echarts/src/main.vue?vue&type=script&lang=js&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    if (!this.manualUpdate) {
      // 延迟加载不监控options变化
      this.$watch('options', function (_new, old) {
        if (!_this.chart && _new) {
          _this.init();
        } else {
          _this.chart.setOption(_new, _new !== old);
        }
      }, {
  ...
  computed: {
    ...
    getDivStyle: function getDivStyle() {
      ...
      return "height:".concat(this.initOptions.height, ";");
    },
    // 判断charts是否有数据
    getHasData: function getHasData() {
      // 获取数据
      var option = this.manualOptions || this.options;
      ...
      try {
        for (var _iterator = option.series[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  methods: {
    ...
    init: function init() {
      ...
      if (!this.chart && this.getHasData) {
        // 创建chart实例
        var chart = window.echarts.init(this.$el, this.theme, this.initOptions); // const chart = echarts.init(document.getElementById(this.elementId), this.theme, this.initOptions)
        ...
        chart.setOption(this.manualOptions || this.options || {}, true); // 绑定事件

        EVENTS.forEach(function (event) {
          if (_this2.$listeners[event]) {
        ...
        if (this.autoresize) {
          ...
          this.resizeHandler = debounce_default()(function () {
            if (_this2.lastArea === 0) {
              _this2.mergeOptions({}, true);

              _this2.resize(); // this.mergeOptions(this.getOption || {}, true)


              _this2.mergeOptions(_this2.options || _this2.manualOptions || {}, true);
            } else {
              _this2.resize();
            }
...
/* harmony default export */ var echarts = (main);
...
var installComponents = _objectSpread({
  install: install
}, components); // export default installComponents
...
//# sourceMappingURL=vue-echarts.umd.js.map