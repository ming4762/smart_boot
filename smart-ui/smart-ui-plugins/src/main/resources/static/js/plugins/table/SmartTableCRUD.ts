...
export default class SmartTableCRUD extends ComponentBuilder {
  ...
  protected components () {
    return {
      ...
      // @ts-ignore
      'smart-button-group': new SmartButtonGroup().build(),
      // @ts-ignore
      'smart-table': new SmartTable().build(),
      // @ts-ignore
      'smart-table-column-visible': new SmartColumnVisible().build()
    }
  }
