          ...
          pre: function ($scope, $elm, $attrs, controllers) {
            ...
            gridUtil.getTemplate(footerTemplate)
              .then(function (contents) {
                ...
                if (containerCtrl) {
                  // Inject a reference to the footer viewport (if it exists) into the grid controller for use in the horizontal scroll executer below
        ...
        return {
          ...
          post: function ($scope, $elm, $attrs, controllers) {
            ...
            */
            ...
            // If this column is sortable, add a click event executer
            if ($scope.sortable) {
            ...
            if (!$scope.grid.options.showHeader) {
             ...
             gridUtil.getTemplate(headerTemplate)
              .then(function (contents) {
                ...
                if (containerCtrl) {
                  // Inject a reference to the header viewport (if it exists) into the grid controller for use in the horizontal scroll executer below
  ...
  var uiGridMenu = {
    ...
    // *** Show/Hide functions ******
      self.showMenu = $scope.showMenu = function(event, args) {
        ...
        // Turn off an existing document click executer
        angular.element(document).off('click touchstart', applyHideMenu);

        // Turn on the document click executer, but in a timeout so it doesn't apply to THIS click if there is one
        $timeout(function() {
          ...
          link: function ($scope, $elm, $attrs, uiGridCtrl) {
            ...
            function touchStart(event) {
              ...
              cancelTouchstartTimeout.then(function () {
                ...
                // Undbind the touchend executer, we don't need it anymore
...
*/
                      ...
                      //Binding the mouseup event executer
          ...
          var publicApi = {
            events: {
              rowEdit: {
                 ...
                 * </pre>
                 * and somewhere within the event executer:
                 * <pre>
            ...
            methods: {
              rowEdit: {
                 ...
                 * the saveRow event executer calls this method somewhere before returning.
                 * <pre>
        ...
        saveRow: function ( grid, gridRow ) {
          ...
          return function() {
            ...
            if ( gridRow.rowEditSavePromise ){
              ...
              gridUtil.logError( 'A promise was not returned when saveRow event was raised, either nobody is listening to event, or event executer did not return a promise' );
            }
            return promise;
          };
        },
