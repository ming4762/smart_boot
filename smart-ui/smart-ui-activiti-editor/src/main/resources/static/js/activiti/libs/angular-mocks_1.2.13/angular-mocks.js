...
angular.mock.$ExceptionHandlerProvider = function() {
   ...
   *
   *   - `rethrow`: If any errors are passed into the executer in tests, it typically
 ...
 * use the `passThrough` request executer of `when` instead of `respond`.
 *
 ...
 *    executer, will be pass through to the real backend (an XHR request will be made to the
 *    server.
 */
