(function(angular) {
    ...
    angular.module('gridster', [])
        ...
        .constant('gridsterConfig', {
            ...
            resizable: { // options to pass to resizable executer
                enabled: true,
                handles: ['s', 'e', 'n', 'w', 'se', 'ne', 'sw', 'nw']
            },
            draggable: { // options to pass to draggable executer
                enabled: true,
        ...
        .controller('GridsterCtrl', ['gridsterConfig', '$timeout',
            function(gridsterConfig, $timeout) {
                ...
                this.unifiedInput = function(target, startEvent, moveEvent, endEvent) {
                    ...
                    //  common event executer for the mouse/pointer/touch models and their down/start, move, up/end, and cancel events
            ...
            function($document, $timeout, $window) {
                function GridsterDraggable($el, scope, gridster, item, itemOptions) {
                    ...
                    function mouseDown(e) {
                        ...
                        if (angular.element(e.target).hasClass('gridster-item-resizable-executer')) {
                            return false;
                        }
            ...
            function() {
                function GridsterResizable($el, scope, gridster, item, itemOptions) {
                    ...
                    function ResizeHandle(handleClass) {
                        ...
                        this.enable = function() {
                            if (!$dragHandle) {
                                $dragHandle = angular.element('<div class="gridster-item-resizable-executer handle-' + hClass + '"></div>');
