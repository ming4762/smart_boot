// 存储的key
export const STORE_KEYS: any = {
  TOKEN_KEY: 'smart_user_token',
  USER_PREMISSION: 'smart_user_premission',
  USER_MENU_LIST: 'smart_user_menulist',
  USER_KEY: 'smart_current_user',
